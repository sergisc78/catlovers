...
<body>
    ...
    $kitten = $result->rowCount();

    $pages = ceil($kitten / $size_page); /*  PAGINATION VARIABLE */

    /* TO SHOW 3 CATS PER PAGE */

    if (!$_GET) { // ALWAYS REDIRECT TO PAGE=1

        header("Location:viewKittens.php?page=1");
    }
    ...
    $kittenCount = $resultLimit->rowCount();
                ...
                <div class="col s8 m12">
                    <div class="card">
                        <div class="card-image">
                            <img src="../../assets/images/kitten/<?php echo $image ?>" width="20%">

                        </div>
                        <div class="card-content center">
                            <p style=" font-family: 'Montserrat', sans-serif;">Name : <?php echo $results['name_kitten'] ?></p>
                            <p style=" font-family: 'Montserrat', sans-serif;">Age : <?php echo $results['age_kitten'] ?></p>
                            <p style=" font-family: 'Montserrat', sans-serif;">Sex: <?php echo $results['sex_kitten'] ?></p>
                            <p style=" font-family: 'Montserrat', sans-serif;">Virus: <?php echo $results['virus'] ?></p>
                            <p style=" font-family: 'Montserrat', sans-serif;">Description : <?php echo $results['descr_kitten'] ?> </p>
                        </div>
                        <div class="button">
                            <a class="btn-large" name="adopt" href="adoptKitten.php?id=<?php echo $results['id_kitten'] ?> & name=<?php echo $results['name_kitten'] ?>" style="display:block;margin-left:auto;margin-right:auto;background-image: linear-gradient(to right,#4A569D,#DC2424);font-size:25px">Would you like to adopt me ?</a>
                        </div><br>
                    </div>
                </div>
            </div>
    ...
    <ul class="pagination center">
        ...
        ?>
            ...
            <li class="<?php echo $_GET['page'] == $i + 1 ? 'active' : '' ?>"><a href="viewKittens.php?page=<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
