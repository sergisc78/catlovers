...
<head>
    ...
    <title>Adopt special case</title>
...
?>
 ...
 <nav class="nav" style="background-image: linear-gradient(to right,#4A569D,#DC2424);min-height: 130px;">
        <div class="container ">
            <div class="nav-wrapper ">
                ...
                <li><a id="options" href="../../views/users/userMenuCats.php" class="home">Home</a></li>
                    <li><a id="options" href="../../views/users/viewSpecials.php" class="home">Back</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <p class="center-align">The subject line will be AdoptSpecialCase:<?php echo $name ?></p>
