...
<body>
    ...
    <h3 class="title-form center">Add a kitten</h3>
    <div class="row">
        <form id="form" action="../kitten/insertKitten.php" method="post" class="col s12" enctype="multipart/form-data">
            <div class="row">
                <br>
                <div class="file-field col s6"><br><br>
                    <div class="file-field input-field">
                        <div class="btn-large">
                            <span>Add a kitten´s image</span>
                            <input type="file" name="image_kitten">
                        </div>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text" name="image_kitten">
                        </div>
                    </div>
                </div>
                <div class="input-field col s6"><br><br>
                    <input id="name_kitten" type="text" class="validate" name="name_kitten" style="font-size: 25px;font-family: 'Roboto', sans-serif;">
                    <label id="label" for="input_text">Name</label>
                    <div id="result-catname" style="font-size: 20px;font-family: 'Roboto', sans-serif;"></div>
                </div>
                <div class="input-field col s6"><br><br>
                    <input id="age" type="text" class="validate" name="age_kitten" style="font-size: 25px;font-family: 'Roboto', sans-serif;">
                    <label id="label" for="input_text">Age</label>
                </div><br>
                <div class="input-field col s6"><br><br>
                    <input id="sex" type="text" class="validate" name="sex_kitten" style="font-size: 25px;font-family: 'Roboto', sans-serif;">
                    <label id="label" for="input_text">Sex</label>
                </div>
                <div class="input-field col s6"><br><br>
                    <textarea id="textarea1" name="descr_kitten" class="materialize-textarea" style="font-size: 25px;font-family: 'Roboto', sans-serif;"></textarea>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#name_kitten').on('blur', function(e) {

                $('#result-catname').html('<img src="../../../assets/images/loader.gif"/>').fadeOut(1000);

                var name = $(this).val();
                var dataString = 'name_kitten=' + name;

                $.ajax({
                    type: "POST",
                    url: "../../../views/admin/kitten/validateKittenName.php",
                    data: dataString,
